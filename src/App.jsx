...
export default function App(){
  ...
  useEffect(()=>{
    ...
    const valid = ['discover','nearby','chat','liked','profile','premium','privacy','safety','terms','guidelines','about','how-it-works','faqs','chats']
        ...
        <div className="max-w-md mx-auto p-6">
          ...
          <div className="mt-10 space-y-6">
            ...
            <div id="signin" className="bg-zinc-900 text-white rounded-[24px] p-5">
              ...
              <input value={form.password} onChange={e=>setForm({...form,password:e.target.value})} placeholder="Password" type="password" className="mt-2 w-full bg-zinc-800 rounded-full px-4 py-3 text-xs" />
            ...
            <div className="bg-[#FFC300] rounded-[24px] p-5">
              ...
              <input value={form.password} onChange={e=>setForm({...form,password:e.target.value})} placeholder="Password" type="password" className="mt-2 w-full bg-white rounded-full px-4 py-3 text-xs" />
              ...
              <button onClick={handleSignup} className="mt-3 w-full bg-black text-white rounded-full py-3 font-black text-xs">Sign Up & Create Profile</button>
            </div>
          </div>
