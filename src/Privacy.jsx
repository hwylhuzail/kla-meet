export default function Privacy(){
 ...
 <h2>5. Safety Features</h2><ul><li>Report & Block button on every profile and chat</li><li>Photo verification optional</li><li>Admin moderation</li><li>Zero tolerance for harassment, nudity without consent, hate, spam</li></ul>
 <h2>6. Your Rights & Deletion</h2><p>You can delete account anytime: App > Profile > Logout + email us. Or email kla.meet.ug@gmail.com with subject DELETE. We delete all data within 30 days.</p>
 <h2>7. Data Retention</h2><p>We keep profile until you delete. Messages 1 year. Banned users data for safety.</p>
 <h2>8. Security</h2><p>Data encrypted in transit (HTTPS), stored securely via Supabase. No app is 100% secure.</p>
 <h2>9. Changes</h2><p>We will notify via app if policy changes.</p>
 <p><a href="/" style={{background:'black',color:'white',padding:'10px 20px',borderRadius:'20px',textDecoration:'none'}}>Back to KLA-MEET</a></p></div>)
}