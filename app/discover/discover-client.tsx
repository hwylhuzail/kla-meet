    ...
    <div className="max-w-md mx-auto bg-white min-h-screen pb-20">
      <div className="p-4 border-b flex justify-between items-center">
        ...
        <div className="flex gap-2">
          <a href="/liked-you" className="text-xs border px-3 py-1.5 rounded-full">❤️ Liked You</a>
      ...
      <div className="p-3 space-y-4">
        {profiles.map((p:any, idx:number) => (
          <div key={`profile-${p.id}`}>
            <div className="rounded-2xl overflow-hidden border shadow-sm bg-white">
              <div className="w-full h-[500px] bg-gray-100">
                <img src={p.avatar_url || 'https://via.placeholder.com/400x600?text=KLA'} className="w-full h-full object-cover" alt="" />
              </div>
            ...
            {/* WHAT YOU GET CARD - After every 2 profiles on discover */}
            {(idx === 1 || idx === 4) &&!me?.is_premium && (
              <div className="mt-4 space-y-3">
                ...
                <div className="bg-white border rounded-2xl p-4">
                  ...
                  <div className="mt-3 text-xs space-y-2">
                    <div className="flex justify-between py-1.5 border-b"><span>Unlimited likes</span><span className="font-bold">✓ Premium</span></div>
                    <div className="flex justify-between py-1.5 border-b"><span>See who liked you</span><span className="font-bold">✓ Premium</span></div>
                    <div className="flex justify-between py-1.5 border-b"><span>Advanced filters</span><span className="font-bold">✓ Premium</span></div>
                    <div className="flex justify-between py-1.5 border-b"><span>Incognito mode</span><span className="font-bold">✓ Premium</span></div>
                    <div className="flex justify-between py-1.5 border-b"><span>Travel mode</span><span className="font-bold">✓ Premium</span></div>
                    <div className="flex justify-between py-1.5 border-b"><span>5 SuperSwipes / week</span><span className="font-bold">✓ Premium</span></div>
                    <div className="flex justify-between py-1.5 border-b"><span>1 Spotlight / week</span><span className="font-bold">✓ Premium</span></div>
                    <div className="flex justify-between py-1.5 border-b"><span>Unlimited Extends</span><span className="font-bold">✓ Premium</span></div>
                    <div className="flex justify-between py-1.5 border-b"><span>Unlimited Rematch</span><span className="font-bold">✓ Premium</span></div>
                    <div className="flex justify-between py-1.5"><span>Unlimited Backtrack</span><span className="font-bold">✓ Premium</span></div>
                  </div>
                </div>
